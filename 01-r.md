...
### R Packages
Sometimes you may need to install some additional packages. An **R package** is a collection of functions, data, documentation that extends the capabilities of base-R. Using packages you can enhance your data exploration capabilities in R. 
...
```
We have assigned values to a variable `Scores` with the assignment operator `<-`. `=` can also be used for assignment but throughout this book we will use R-community preferred one ,i.e., `<-`.
The value don't get automatically displayed unless we call the variable.
...
## [1] 22.9
```
To calculate standard deviation you can use `sd()` function
...
```
Selecting some entries of `Scores2`
...
### Creating a sequence as vectors
...
<img src="01-r_files/figure-html/unnamed-chunk-19-1.png" width="672" />

Then we know it's shape is symmetric about $x = \frac{1}{2}$. But if we take the density of $Poi(4)$.

<img src="01-r_files/figure-html/unnamed-chunk-20-1.png" width="672" />
...
<img src="01-r_files/figure-html/unnamed-chunk-32-1.png" width="672" />
...
<img src="01-r_files/figure-html/unnamed-chunk-33-1.png" width="672" />
...
<img src="01-r_files/figure-html/unnamed-chunk-34-1.png" width="672" />
...
<img src="01-r_files/figure-html/unnamed-chunk-35-1.png" width="672" />
...
<img src="01-r_files/figure-html/unnamed-chunk-42-1.png" width="672" />
